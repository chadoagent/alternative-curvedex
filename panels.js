...
(function () {
  ...
  function getRouteKey() {
    ...
    // Route carries the chain slug first (#/ethereum/yield/…) — strip it or
    // every prefix test below misses (crvecodev/2156).
    const _raw = (typeof window !== 'undefined' && window.location && window.location.hash) || '';
    const h = (typeof window !== 'undefined' && typeof window.routePath === 'function') ? window.routePath() : _raw;
